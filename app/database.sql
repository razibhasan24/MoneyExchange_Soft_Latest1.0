...
INSERT INTO `core_mex_currencies` (`id`,`currency_code`,`currency_name`,`symbol`,`image`) VALUES 
 (1,'USD','US Dollar','$','usd.png'),
 (2,'EUR','Euro','Ôé¼','eur.png'),
 (3,'GBP','British Pound','?ú','gbp.png'),
 (4,'JPY','Japanese Yen','?Ñ','jpy.png'),
 (5,'BDT','Bangladeshi Taka','Óº?','bdt.png');
...
INSERT INTO `core_mex_invoice_details` (`id`,`invoice_id`,`description`,`quantity`,`unit_price`,`total_price`) VALUES 
...
INSERT INTO `core_mex_money_stocks` (`id`,`currency_id`,`qty`,`transaction_type`,`remarks`,`purchase_id`) VALUES 
 (1,1,'1200.00','IN','USD from purchase #1',0),
 (2,2,'700.00','IN','EUR from purchase #2',0),
 (3,3,'950.00','IN','GBP from purchase #3',0),
 (4,1,'200.00','OUT','USD given to client',0),
 (5,4,'2500.00','IN','Other currency added from bulk deal',0),
 (6,1,'10.00','IN','USD purchase',8),
 (7,2,'5.00','IN','EUR purchase',8),
 (8,1,'10.00','IN','USD purchase',9),
 (9,2,'5.00','IN','EUR purchase',9),
 (10,4,'241.00','IN',NULL,19),
 (11,1,'100.00','IN','First batch',20),
 (12,2,'50.00','IN','Second batch',20),
 (13,1,'100.00','IN','First batch',21),
 (14,2,'50.00','IN','Second batch',21),
 (15,1,'-1000.00','OUT','USD transaction',27),
 (16,2,'-1500.00','OUT','EUR transaction',27),
 (17,1,'-1000.00','OUT','USD transaction',28),
 (18,2,'-1500.00','OUT','EUR transaction',28),
 (19,1,'-1000.00','OUT','USD transaction',30),
 (20,2,'-1500.00','OUT','EUR transaction',30),
 (21,1,'100.00','IN','First batch',27),
 (22,2,'50.00','IN','Second batch',27),
 (23,1,'100.00','IN','First batch',30),
 (24,2,'50.00','IN','Second batch',30),
 (25,4,'568.00','IN','Purchase',31),
 (26,4,'43.00','IN','Purchase',31),
 (27,3,'623.00','IN','Purchase',31),
 (28,1,'415.00','IN','Purchase',32),
 (29,4,'988.00','IN','Purchase',32),
 (30,3,'-41.00','OUT','Seals',53),
 (31,2,'-68.00','OUT','Seals',53),
 (32,1,'-67.00','OUT','Seals',54),
 (33,3,'-2.00','OUT','Seals',54);
...
--
-- Definition of table `core_mex_purchase_detailseeee`
--

DROP TABLE IF EXISTS `core_mex_purchase_detailseeee`;
CREATE TABLE `core_mex_purchase_detailseeee` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `purchase_id` int(11) NOT NULL,
  ...
  PRIMARY KEY (`id`),
  KEY `purchase_id` (`purchase_id`),
  CONSTRAINT `core_mex_purchase_detailseeee_ibfk_1` FOREIGN KEY (`purchase_id`) REFERENCES `core_mex_purchaseseee` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;

--
-- Dumping data for table `core_mex_purchase_detailseeee`
--

/*!40000 ALTER TABLE `core_mex_purchase_detailseeee` DISABLE KEYS */;
INSERT INTO `core_mex_purchase_detailseeee` (`id`,`purchase_id`,`item_description`,`quantity`,`unit_price`,`total_price`) VALUES 
 (2,14,'euro v usd',100,'120.00','12000.00'),
 (3,15,'Ea dignissimos tempo',317,'803.00','254551.00'),
 (4,15,'Aliquid in dolor con',456,'374.00','170544.00'),
 (5,16,'Excepturi reprehende',325,'721.00','234325.00'),
 (6,16,'Sit occaecat optio',879,'849.00','746271.00'),
 (7,18,'1',10,'2.00','20.00'),
 (8,18,'2',85,'837.00','71145.00');
/*!40000 ALTER TABLE `core_mex_purchase_detailseeee` ENABLE KEYS */;
...
--
-- Definition of table `core_mex_purchaseseee`
--

DROP TABLE IF EXISTS `core_mex_purchaseseee`;
CREATE TABLE `core_mex_purchaseseee` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `core_mex_purchaseseee`
--

/*!40000 ALTER TABLE `core_mex_purchaseseee` DISABLE KEYS */;
INSERT INTO `core_mex_purchaseseee` (`id`,`supplier_id`,`purchase_date`,`total_amount`,`status`,`agent_id`) VALUES 
 (14,0,'2025-07-10','50000.00',NULL,1),
 (15,3,'1986-11-18','18.00','Active',2),
 (16,2,'1973-09-29','90.00','Active',3),
 (17,1,'2004-11-07','32.00','Active',4),
 (18,5,'2005-11-27','38.00','Active',0);
/*!40000 ALTER TABLE `core_mex_purchaseseee` ENABLE KEYS */;
...
INSERT INTO `core_mex_users` (`id`,`username`,`password_hash`,`full_name`,`role`,`created_at`) VALUES 
 (1,'admin','hash_admin_123','Administrator','admin','2025-07-09 10:04:06'),
 (2,'agent1','hash_agent1_456','Agent One','agent','2025-07-09 10:04:06'),
 (3,'agent2','hash_agent2_789','Agent Two','agent','2025-07-09 10:04:06'),
 (4,'accountant','hash_account_101','Accountant','account','2025-07-09 10:04:06'),
 (5,'manager','hash_manager_202','Manager','manager','2025-07-09 10:04:06');
