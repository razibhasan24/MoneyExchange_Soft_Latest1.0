            ...
            <div class="row">
                <div class="col-12 d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        ...
                        <a href="{{ route('agents.edit', $agent->id) }}" class="btn btn-warning btn-sm" title="Edit">
            ...
            <div class="card-body">
                ...
                <div class="mt-4 d-flex justify-content-between">
                    ...
                    @if(isset($agent->status))
                        <span class="badge
                            @if($agent->status == 'active') bg-success @endif
                            @if($agent->status == 'inactive') bg-danger @endif
                            @if($agent->status == 'pending') bg-warning @endif">
