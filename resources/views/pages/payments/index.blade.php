...
@section('page-title', 'Payment Page')
@section('pages')
    ...
    <div class="card bg-info mb-3 p-4">
        <div class="row">
            <div class="col-12 d-flex justify-content-between align-item-center ">
                <h3 class=" card-title text-white d-flex align-items-center  m-0">Payment List</h3>
                <a href="{{ route('payments.create') }}" class="btn btn-light btn-sm" title="Create New Product">
                    <i class="fa fa-plus mr-1"></i> Create New Payment
                </a>
            </div>
        </div>
    </div>
