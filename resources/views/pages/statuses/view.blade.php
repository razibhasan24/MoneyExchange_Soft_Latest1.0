            ...
            <div class="row">
                <div class="col-12 d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        ...
                        <a href="{{ route('statuses.edit', $status->id) }}" class="btn btn-warning btn-sm" title="Edit">
            ...
            <div class="card-body">
                ...
                <div class="mt-4 d-flex justify-content-between">
                    ...
                    @if(isset($status->status))
                        <span class="badge
                            @if($status->status == 'active') bg-success @endif
                            @if($status->status == 'inactive') bg-danger @endif
                            @if($status->status == 'pending') bg-warning @endif">
