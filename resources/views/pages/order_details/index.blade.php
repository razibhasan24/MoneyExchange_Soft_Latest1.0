...
@section('page-title', 'OrderDetail Page')
@section('pages')
    ...
    <div class="card bg-info mb-3 p-4">
        <div class="row">
            <div class="col-12 d-flex justify-content-between align-item-center ">
                <h3 class=" card-title text-white d-flex align-items-center  m-0">OrderDetail List</h3>
                <a href="{{ route('order_details.create') }}" class="btn btn-light btn-sm" title="Create New Product">
                    <i class="fa fa-plus mr-1"></i> Create New OrderDetail
                </a>
            </div>
        </div>
    </div>
